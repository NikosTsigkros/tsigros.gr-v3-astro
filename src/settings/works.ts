...
export const works: WorkEntry[] = [
  ...
  },
  {
    popupId: 3,
    filters: "f-wordpress",
    thumbSrc: "images/works/small/ready-cars-screen-small.jpg",
    thumbAlt: "ReadyCars - Car Sales Website",
    fullSrc: "images/works/ready-cars-screen.png",
    fullAlt: "ReadyCars - Full Website Preview",
    category: "Website",
    title: "ReadyCars",
    description:
      "Designed and built the website for ReadyCars, a car sales business that needed a clear way to present stock, highlight vehicle details, and make it easy for buyers to get in touch. The site focuses on fast loading, mobile-friendly browsing, and a straightforward layout so visitors can scan listings and reach the showroom without friction.",
    technologies: "Technologies : Wordpress",
    projectUrl: "https://readycars.gr",
  },
  {
    popupId: 4,
